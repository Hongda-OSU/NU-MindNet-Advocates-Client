...
const Homepage = () => {
  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="80vh" flexDirection="row" gap={15}>
      <Button
        variant="contained"
        color="primary"
      ...
      {hasResults ? (
        ...
        <Tooltip title="No results available, please take the questionary first" placement="bottom">
          <span>
            <Button
              variant="contained"
              disabled
              sx={{ padding: '10px 30px', fontSize: '1.25rem', backgroundColor: 'grey' }}
            >
              View Results
            </Button>
          </span>
